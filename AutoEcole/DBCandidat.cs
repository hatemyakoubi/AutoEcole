...
namespace AutoEcole
{
    class DBCandidat
    {
        ...
        public static void AddCandidat(Candidat cdt)
        {
            ...
            {
                MessageBox.Show("Erreur d\'ajout un candidat. \n" + ex.Source, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            con.Close();
        }
        public static void UpdateCandidat(Candidat cdt,string id)
        {
            ...
            {
                MessageBox.Show("Erreur de modification un candidat. \n" + ex.StackTrace, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            con.Close();
        }

        public static void deleteCandidat(string id)
        {
            string req = "DELETE FROM candidat WHERE idCandidat=@id";
            MySqlConnection con = GetConnection();
            MySqlCommand cmd = new MySqlCommand(req, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("@id", MySqlDbType.VarChar).Value = id;
            ...
            {
                cmd.ExecuteNonQuery();
                MessageBox.Show("Candidat a été supprimer avec succées . \n", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public static void DisplayAndSearchCandidat(string querry, DataGridView dgv)
        {
            string sql = querry;
            MySqlConnection con = GetConnection();
